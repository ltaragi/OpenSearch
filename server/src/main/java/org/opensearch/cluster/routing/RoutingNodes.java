...
public class RoutingNodes implements Iterable<RoutingNode> {
    ...
    /**
     * Returns one active replica existing on a remote store node
     * Falls back onto <code>activeReplicaWithOldestVersion</code> if no replica is found on a remote store node
     */
    public ShardRouting activeReplicaOnRemoteNode(ShardId shardId) {
        ...
        if (replicaShardsOnRemote.isEmpty() == false) {
            ...
            System.out.println("*** replicaShard = " + replicaShard);
        }
        return replicaShard;
    }
